...
import 'package:s_help/fitness_app/my_diary/nview.dart';
...
class NNotification extends StatefulWidget {
  const NNotification({Key? key, this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _NNotificationState createState() => _NNotificationState();
}
